...
// VendorDisclosed returns whether a vendor ID has been disclosed in the Disclosed Vendors segment.
...
// HasDisclosedVendorsSegment returns whether the Disclosed Vendors segment is present.
func (c ConsentMetadata) HasDisclosedVendorsSegment() bool {
	return c.disclosedVendors != nil
}
